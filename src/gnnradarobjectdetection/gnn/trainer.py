...
from gnnradarobjectdetection.gnn.configs import TrainingConfig, GNNArchitectureConfig
from gnnradarobjectdetection.utils.radar_scenes_properties import ClassDistribution
from gnnradarobjectdetection.preprocessor.bounding_box import adapt_bb_orientation_angle
...
class Trainer():
    ...
    def save_results(self, path: str, model_config: GNNArchitectureConfig, dataset_config_dict: dict) -> None:
        ...
        # QT error, uncomment by Denis 20230718
